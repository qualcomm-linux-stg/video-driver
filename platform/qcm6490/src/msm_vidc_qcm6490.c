...
#define MAXIMUM_FPS_DEC         480
#define MAXIMUM_FPS_ENC         240
...
static struct color_primaries_info color_primaries_data_qcm6490[] = {
    {
...
static struct transfer_char_info transfer_char_data_qcm6490[] = {
    {
...
static struct matrix_coeff_info matrix_coeff_data_qcm6490[] = {
    {
...
static struct msm_platform_core_capability core_data_qcm6490[] = {
    /* {type, value} */
...
static struct msm_platform_inst_capability instance_cap_data_qcm6490[] = {
    /* {cap, domain, codec,
    ...
    {FRAME_RATE, ENC, CODECS_ALL,
        (MINIMUM_FPS << 16), (MAXIMUM_FPS_ENC << 16),
        1, (DEFAULT_FPS << 16),
        0,
        HFI_PROP_FRAME_RATE,
    ...
    {FRAME_RATE, DEC, CODECS_ALL,
        (MINIMUM_FPS << 16), (MAXIMUM_FPS_DEC << 16),
        1, (DEFAULT_FPS << 16),
...
static struct msm_platform_inst_cap_dependency instance_cap_dependency_data_qcm6490[] = {
    /* {cap, domain, codec,
     *      parents,
     *      children,
     *      adjust, set}
...
static struct msm_vidc_ubwc_config_data ubwc_config_qcm6490[] = {
    UBWC_CONFIG(8, 32, 15, 0, 1, 1, 1),
};

static struct msm_vidc_efuse_data efuse_data_qcm6490[] = {
    /* IRIS_MULTIPIPE_DISABLE - max 4K@30 */
    EFUSE_ENTRY(0x221C8118, 4, 0x400, 0xA, SKU_VERSION),
};

static struct msm_vidc_format_capability format_data_qcm6490 = {
    ...
    .color_prim_info = color_primaries_data_qcm6490,
    .color_prim_info_size = ARRAY_SIZE(color_primaries_data_qcm6490),
    .transfer_char_info = transfer_char_data_qcm6490,
    .transfer_char_info_size = ARRAY_SIZE(transfer_char_data_qcm6490),
    .matrix_coeff_info = matrix_coeff_data_qcm6490,
    .matrix_coeff_info_size = ARRAY_SIZE(matrix_coeff_data_qcm6490),
};
...
static const struct pd_table qcm6490_pd_table[] = {
    { "venus"   },
    { "vcodec0" },
};
...
const struct context_bank_table qcm6490_context_bank_table[] = {
    {"qcom,vidc,cb-ns", 0x25800000, 0x0, 0, 1, MSM_VIDC_NON_SECURE, 0xe0000000 - 1},
    {"qcom,vidc,cb-sec-non-pxl",   0x01000000, 0x24800000, 1, 0, MSM_VIDC_SECURE_NONPIXEL,  0 },
};

/* freq */
static struct freq_table qcm6490_freq_table_sku0[] = {
...
/* register, value, mask */
static const struct reg_preset_table qcm6490_reg_preset_table[] = {
    { 0xB0088, 0x0,        0x11      },
};

/* decoder properties */
static const u32 qcm6490_vdec_psc_avc[] = {
...
static const struct msm_vidc_platform_data qcm6490_data = {
    ...
    .bw_tbl = qcm6490_bw_table,
    .bw_tbl_size = ARRAY_SIZE(qcm6490_bw_table),
    .clk_tbl = qcm6490_clk_table,
    .clk_tbl_size = ARRAY_SIZE(qcm6490_clk_table),

    /* populate context bank */
    .context_bank_tbl = qcm6490_context_bank_table,
    .context_bank_tbl_size = ARRAY_SIZE(qcm6490_context_bank_table),

    /* platform specific resources */
    .freq_tbl = qcm6490_freq_table_sku0,
    ...
    .inst_cap_dependency_data = instance_cap_dependency_data_qcm6490,
    .inst_cap_dependency_data_size = ARRAY_SIZE(instance_cap_dependency_data_qcm6490),
    ...
    .psc_avc_tbl = qcm6490_vdec_psc_avc,
    .psc_avc_tbl_size = ARRAY_SIZE(qcm6490_vdec_psc_avc),
    .psc_hevc_tbl = qcm6490_vdec_psc_hevc,
    .psc_hevc_tbl_size = ARRAY_SIZE(qcm6490_vdec_psc_hevc),
    .psc_vp9_tbl = qcm6490_vdec_psc_vp9,
    .psc_vp9_tbl_size = ARRAY_SIZE(qcm6490_vdec_psc_vp9),
    .dec_input_prop_avc = qcm6490_vdec_input_properties_avc,
    .dec_input_prop_hevc = qcm6490_vdec_input_properties_hevc,
    .dec_input_prop_vp9 = qcm6490_vdec_input_properties_vp9,
    .dec_input_prop_size_avc = ARRAY_SIZE(qcm6490_vdec_input_properties_avc),
    .dec_input_prop_size_hevc = ARRAY_SIZE(qcm6490_vdec_input_properties_hevc),
    .dec_input_prop_size_vp9 = ARRAY_SIZE(qcm6490_vdec_input_properties_vp9),
    ...
    .efuse_data = efuse_data_qcm6490,
    .efuse_data_size = ARRAY_SIZE(efuse_data_qcm6490),
...
static int msm_vidc_init_data(struct msm_vidc_core *core)
{
    ...
    d_vpr_h("%s: initialize qcm6490 data\n", __func__);

    core->platform->data = qcm6490_data;
...
int msm_vidc_init_platform_qcm6490(struct msm_vidc_core *core)
{
    int rc = 0;
